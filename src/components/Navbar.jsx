...
export default function Navbar() {
  ...
  const [gamingHover, setGamingHover] = useState(false)
  ...
  const onMouseEnterTip = (setState) => {
    timeout = setTimeout(() => {
      setState(true)
    }, 400)
  }

  const onMouseLeaveTip = (setState) => {
    setState(false)
  ...
  return (
    <div className='navbar'>
      ...
      <div className='navbar__middle'>
        <div
          className='navbar__middle__option navbar__middle__option--active'
          onMouseEnter={(e) => onMouseEnterTip(setHomeHover)}
          onMouseLeave={(e) => onMouseLeaveTip(setHomeHover)}>
          <svg viewBox='0 0 28 28' className='navbar__middle__option__icon' height='28' width='28'>
          ...
          <Tip text='Home' homeHover={homeHover} />
        </div>

        <div
          className='navbar__middle__option'
          onMouseEnter={(e) => onMouseEnterTip(setFriendsHover)}
          onMouseLeave={(e) => onMouseLeaveTip(setFriendsHover)}>
          <svg viewBox='0 0 28 28' className='navbar__middle__option__icon' height='28' width='28'>
          ...
          <Tip text='Friends' friendsHover={friendsHover} />
        </div>

        <div
          className='navbar__middle__option'
          onMouseEnter={(e) => onMouseEnterTip(setWatchHover)}
          onMouseLeave={(e) => onMouseLeaveTip(setWatchHover)}>
          <svg viewBox='0 0 28 28' className='navbar__middle__option__icon' fill='gray' height='28' width='28'>
          ...
          <Tip text='Watch' homeHover={watchHover} />
        </div>

        <div
          className='navbar__middle__option'
          onMouseEnter={(e) => onMouseEnterTip(setGroupsHover)}
          onMouseLeave={(e) => onMouseLeaveTip(setGroupsHover)}>
          <svg viewBox='0 0 28 28' className='navbar__middle__option__icon' fill='gray' height='28' width='28'>
          ...
          <Tip text='Groups' homeHover={groupsHover} />
        </div>

        <div
          className='navbar__middle__option'
          onMouseEnter={(e) => onMouseEnterTip(setGamingHover)}
          onMouseLeave={(e) => onMouseLeaveTip(setGamingHover)}>
          <svg viewBox='0 0 28 28' className='navbar__middle__option__icon' fill='gray' height='28' width='28'>
          ...
          <Tip text='Gaming' homeHover={gamingHover} />
        </div>
      </div>
      <div className='navbar__right'>
        <div className='navbar__right__info'>
          <div className='navbar__right__info__user'>
            <Avatar className='navbar__right__info__user__avatar' />
            <h4>William</h4>
          </div>
